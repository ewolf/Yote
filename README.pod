...
Yote is still in a pre alpha state and is being developed. 
A large part of the development is documentation and communication. 
Yote is not ready for production at the time of this writing and will not be advertised as such.
